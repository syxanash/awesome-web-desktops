...
* **Vibecoded** template-based projects created with no-code and automated web-app generators are not accepted. I'm ok with the use of LLMs, since I have no way to verify your code. However, projects created using websites such as _Websim_ are not allowed.
